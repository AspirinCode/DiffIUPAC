...
from tokenizer_utils import create_iupac_smiles_tokenizer #create_tokenizer
...
def main():
    ...
    iupac_tokenizer,smiles_tokenizer = create_iupac_smiles_tokenizer(return_pretokenized=True,
                                 path=f"data/{args.dataset}/",
                                 tokenizer_ckpt='./data') #
    ...
    args.vocab_size = iupac_tokenizer.vocab_size

    args.load_ckpt=args.model_name_or_path

    args.resume_checkpoint=args.checkpoint_path
    
    logger.log("creating model and diffusion...", args.checkpoint_path)
    model, diffusion = create_model_and_diffusion(
        pad_tok_id=iupac_tokenizer.pad_token_id if hasattr(iupac_tokenizer, 'pad_token_id') else iupac_tokenizer.get_vocab()['<pad>'],
